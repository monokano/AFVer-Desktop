...
/// 独自ウインドウに更新履歴（リモートHTML）を表示する。実装は Glow Id に準拠。
...
private struct ChangeLogRootView: View {
    ...
    private let releasesURL = URL(string: "https://github.com/monokano/AFVer-Desktop/releases")!
...
private struct ChangeLogView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> WKWebView {
        ...
        let urlStr = "https://tama-san.com/afver-desktop/afver-desktop-change-log-\(lang).html?\(UUID().uuidString)"
